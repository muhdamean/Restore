    ...
    public partial class OrderEntityAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BuyerId = table.Column<string>(type: "TEXT", nullable: true),
                    ShippingAddress_FulName = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false),
                    FulName = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "9f8c9a95-e6ba-452b-8055-65e2e92fc452", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "810fe5c2-18da-4def-93e2-3c4916e57d26", "Admin", "ADMIN" });
